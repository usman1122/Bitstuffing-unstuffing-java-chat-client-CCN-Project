...
public class client_frame extends javax.swing.JFrame 
{
 ...
 ArrayList<String> users = new ArrayList();
    ...
    private void initComponents() {
        ...
        lb_address.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        ...
        lb_port.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        lb_username.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        ...
        lb_password.setFont(new java.awt.Font("Trebuchet MS", 3, 14)); // NOI18N
        lb_password.setText("Password : ");

        b_connect.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        b_connect.setText("Connect");
        b_connect.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        b_disconnect.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        b_disconnect.setText("Disconnect");
        b_disconnect.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        b_anonymous.setBackground(new java.awt.Color(0, 102, 51));
        b_anonymous.setForeground(new java.awt.Color(102, 153, 0));
        b_anonymous.setText("log in");
        b_anonymous.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, null, java.awt.Color.darkGray, null, null));
        ...
        ta_chat.setBackground(new java.awt.Color(102, 204, 255));
        ta_chat.setColumns(20);
        ta_chat.setRows(5);
        jScrollPane1.setViewportView(ta_chat);

        b_send.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        b_send.setForeground(new java.awt.Color(255, 0, 0));
        b_send.setText("SEND BITS");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(b_anonymous, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(tf_username)
                    .addComponent(tf_password)
    ...
    private void b_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_sendActionPerformed
        ...
        String stuffed =
            new String(res);
        writer.println(username + ":" + "(After stuffing) --> " + stuffed + ":" + "Chat" );
                    ...
                    if(stuffed.charAt(i) == '1')
                        {
                            ...
                            counter++;
                            Destuffed = Destuffed + stuffed.charAt(i);
                   ...
                   if(counter == 5)
                        {
                            String zero = new String();
                              zero = zero + stuffed.charAt(i+1);
                              i++;
                             counter = 0;
                        }
                }
      
        writer.println(username + ":" + "(Destuffed bits)-> " + Destuffed + ":" + "Chat");
